...
public class NjsSdkTest3Client {
     ...
     * credentials.
     */
    public NjsSdkTest3Client(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public UObject run(UObject params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<UObject> res = caller.jsonrpcCall("njs_sdk_test_3.run", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("njs_sdk_test_3.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
